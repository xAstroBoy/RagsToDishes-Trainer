...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_DULG[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_A5O1[0x8];                                   // 0x0010(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_MAI6[0x8];                                   // 0x0020(0x0008) MISSED OFFSET (PADDING)
	};
