...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_Keyboard_Key_Backspace.BP_Keyboard_Key_Backspace_C.Grab
	 */
	struct ABP_Keyboard_Key_Backspace_C_Grab_Params
	{
	public:
		...
		unsigned char                                              UnknownData_D9ZP[0x7];                                   // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BP_Keyboard_Key_Backspace.BP_Keyboard_Key_Backspace_C.UserConstructionScript
	 */
	struct ABP_Keyboard_Key_Backspace_C_UserConstructionScript_Params
	{	};

	/**
	 * Function BP_Keyboard_Key_Backspace.BP_Keyboard_Key_Backspace_C.ReceiveBeginPlay
	 */
	struct ABP_Keyboard_Key_Backspace_C_ReceiveBeginPlay_Params
	{	};

	/**
	 * Function BP_Keyboard_Key_Backspace.BP_Keyboard_Key_Backspace_C.ExecuteUbergraph_BP_Keyboard_Key_Backspace
	 */
	struct ABP_Keyboard_Key_Backspace_C_ExecuteUbergraph_BP_Keyboard_Key_Backspace_Params
	{
	public:
