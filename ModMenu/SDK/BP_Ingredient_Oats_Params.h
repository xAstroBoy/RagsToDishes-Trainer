...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_Ingredient_Oats.BP_Ingredient_Oats_C.Grab
	 */
	struct ABP_Ingredient_Oats_C_Grab_Params
	{
	public:
		...
		unsigned char                                              UnknownData_Z03W[0x7];                                   // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BP_Ingredient_Oats.BP_Ingredient_Oats_C.UserConstructionScript
	 */
	struct ABP_Ingredient_Oats_C_UserConstructionScript_Params
	{	};

	/**
	 * Function BP_Ingredient_Oats.BP_Ingredient_Oats_C.ForceRelease
	 */
	struct ABP_Ingredient_Oats_C_ForceRelease_Params
	{	};

	/**
	 * Function BP_Ingredient_Oats.BP_Ingredient_Oats_C.Release
	 */
	struct ABP_Ingredient_Oats_C_Release_Params
	{	};

	/**
	 * Function BP_Ingredient_Oats.BP_Ingredient_Oats_C.ExecuteUbergraph_BP_Ingredient_Oats
	 */
	struct ABP_Ingredient_Oats_C_ExecuteUbergraph_BP_Ingredient_Oats_Params
	{
	public:
