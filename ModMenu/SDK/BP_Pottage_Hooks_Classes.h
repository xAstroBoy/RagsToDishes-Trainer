...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Pottage_Hooks.BP_Pottage_Hooks_C
	 * Size -> 0x0024 (FullSize[0x034C] - InheritedSize[0x0328])
	 */
	class ABP_Pottage_Hooks_C : public AActor
	{
	public:
		...
		int32_t                                                    Level;                                                   // 0x0348(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash

	public:
		void UserConstructionScript();
		void UnlockBeanPottage();
		void ExecuteUbergraph_BP_Pottage_Hooks(int32_t EntryPoint);
