...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_Keyboard_Key.BP_Keyboard_Key_C.Grab
	 */
	struct ABP_Keyboard_Key_C_Grab_Params
	{
	public:
		...
		unsigned char                                              UnknownData_PABT[0x7];                                   // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BP_Keyboard_Key.BP_Keyboard_Key_C.IsHeldByController
	 */
	struct ABP_Keyboard_Key_C_IsHeldByController_Params
	{
	public:
		class USceneComponent*                                     MotionController;                                        // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	/**
	 * Function BP_Keyboard_Key.BP_Keyboard_Key_C.UserConstructionScript
	 */
	struct ABP_Keyboard_Key_C_UserConstructionScript_Params
	{	};

	/**
	 * Function BP_Keyboard_Key.BP_Keyboard_Key_C.ReceiveBeginPlay
	 */
	struct ABP_Keyboard_Key_C_ReceiveBeginPlay_Params
	{	};

	/**
	 * Function BP_Keyboard_Key.BP_Keyboard_Key_C.DisableHighlight
	 */
	struct ABP_Keyboard_Key_C_DisableHighlight_Params
	{	};

	/**
	 * Function BP_Keyboard_Key.BP_Keyboard_Key_C.EnableHighlight
	 */
	struct ABP_Keyboard_Key_C_EnableHighlight_Params
	{	};

	/**
	 * Function BP_Keyboard_Key.BP_Keyboard_Key_C.Release
	 */
	struct ABP_Keyboard_Key_C_Release_Params
	{	};

	/**
	 * Function BP_Keyboard_Key.BP_Keyboard_Key_C.ExecuteUbergraph_BP_Keyboard_Key
	 */
	struct ABP_Keyboard_Key_C_ExecuteUbergraph_BP_Keyboard_Key_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_T09K[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
