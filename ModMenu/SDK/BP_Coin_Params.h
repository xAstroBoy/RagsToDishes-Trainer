...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_Coin.BP_Coin_C.Grab
	 */
	struct ABP_Coin_C_Grab_Params
	{
	public:
		...
		unsigned char                                              UnknownData_CGFF[0x7];                                   // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BP_Coin.BP_Coin_C.IsHeldByController
	 */
	struct ABP_Coin_C_IsHeldByController_Params
	{
	public:
		class USceneComponent*                                     MotionController;                                        // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	/**
	 * Function BP_Coin.BP_Coin_C.DeleteSpawnedActor
	 */
	struct ABP_Coin_C_DeleteSpawnedActor_Params
	{	};
	...
	/**
	 * Function BP_Coin.BP_Coin_C.EnableHighlight
	 */
	struct ABP_Coin_C_EnableHighlight_Params
	{	};

	/**
	 * Function BP_Coin.BP_Coin_C.DisableHighlight
	 */
	struct ABP_Coin_C_DisableHighlight_Params
	{	};

	/**
	 * Function BP_Coin.BP_Coin_C.Release
	 */
	struct ABP_Coin_C_Release_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_66PI[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
