...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass Widget_SE_Bean_Pottage.Widget_SE_Bean_Pottage_C
	 * Size -> 0x0068 (FullSize[0x02F8] - InheritedSize[0x0290])
	 */
	class UWidget_SE_Bean_Pottage_C : public UWidget_UI_C
	{
	public:
		...
		class UTextBlock*                                          _2TutText;                                               // 0x02C8(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		...
		class UHorizontalBox*                                      DishIcons;                                               // 0x02E0(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_6P9C[0x4];                                   // 0x02EC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class ABP_Story_Event_Bean_Pottage_C*                      StoryEventRef;                                           // 0x02F0(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void SkipTextRender();
		void ExecuteUbergraph_Widget_SE_Bean_Pottage(int32_t EntryPoint);
