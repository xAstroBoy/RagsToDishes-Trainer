...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass Widget_SE_Royals_Cake.Widget_SE_Royals_Cake_C
	 * Size -> 0x0070 (FullSize[0x0300] - InheritedSize[0x0290])
	 */
	class UWidget_SE_Royals_Cake_C : public UWidget_UI_C
	{
	public:
		...
		class UVerticalBox*                                        CakeTutorial;                                            // 0x02D0(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_6VJ0[0x4];                                   // 0x02F4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class ABP_Story_Event_Royals_Cake_Tutorial_C*              StoryEventRef;                                           // 0x02F8(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void SkipTextRender();
		void ExecuteUbergraph_Widget_SE_Royals_Cake(int32_t EntryPoint);
