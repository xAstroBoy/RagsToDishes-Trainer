...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_122A[0x2];                                   // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_D5DW[0x3];                                   // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_L44T[0x5];                                   // 0x004B(0x0005) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_MQAP[0x10];                                  // 0x0000(0x0010) MISSED OFFSET (PADDING)
	};
