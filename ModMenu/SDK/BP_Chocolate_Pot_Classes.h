...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Chocolate_Pot.BP_Chocolate_Pot_C
	 * Size -> 0x001D (FullSize[0x0389] - InheritedSize[0x036C])
	 */
	class ABP_Chocolate_Pot_C : public ABP_Equipment_C
	{
	public:
		unsigned char                                              UnknownData_WO55[0x4];                                   // 0x036C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void SpawnSpoon();
		void ExecuteUbergraph_BP_Chocolate_Pot(int32_t EntryPoint);
