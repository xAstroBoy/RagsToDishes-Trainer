...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * UserDefinedStruct Struct_Noble_Event_Progress.Struct_Noble_Event_Progress
	 * Size -> 0x0030
	 */
	struct FStruct_Noble_Event_Progress
	{
	public:
		Enum_Upgrade_Levels_Nobles                                 Event_18_23683DBC4010003047FBE581CB7BB540;               // 0x0000(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_HTC4[0x5];                                   // 0x0003(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
