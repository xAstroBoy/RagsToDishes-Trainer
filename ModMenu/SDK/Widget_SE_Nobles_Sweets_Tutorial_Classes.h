...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass Widget_SE_Nobles_Sweets_Tutorial.Widget_SE_Nobles_Sweets_Tutorial_C
	 * Size -> 0x0061 (FullSize[0x02F1] - InheritedSize[0x0290])
	 */
	class UWidget_SE_Nobles_Sweets_Tutorial_C : public UWidget_UI_C
	{
	public:
		...
		unsigned char                                              UnknownData_HVAD[0x4];                                   // 0x02E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class ABP_Story_Event_Sweets_Tutorial_C*                   StoryEventRef;                                           // 0x02E8(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void SkipTextRender();
		void ExecuteUbergraph_Widget_SE_Nobles_Sweets_Tutorial(int32_t EntryPoint);
