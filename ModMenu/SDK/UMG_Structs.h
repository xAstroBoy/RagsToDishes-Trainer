...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_BQHU[0xB8];                                  // 0x0000(0x00B8) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_XL5Z[0x3];                                   // 0x0005(0x0003) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_Z3BS[0x30];                                  // 0x0000(0x0030) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_Z4RR[0x7];                                   // 0x0021(0x0007) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_U301[0x7];                                   // 0x0049(0x0007) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_EX7P[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class FScriptDelegate                                      CustomDelegate;                                          // 0x0018(0x0010) ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPublic
	};
	...
	public:
		...
		unsigned char                                              UnknownData_Y1CD[0x3];                                   // 0x04A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_NLE1[0x7];                                   // 0x02C9(0x0007) MISSED OFFSET (PADDING)
	};
