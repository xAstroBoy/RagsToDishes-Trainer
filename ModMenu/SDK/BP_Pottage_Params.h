...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_Pottage.BP_Pottage_C.Grab
	 */
	struct ABP_Pottage_C_Grab_Params
	{
	public:
		...
		unsigned char                                              UnknownData_EWFU[0x7];                                   // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BP_Pottage.BP_Pottage_C.IsHeldByController
	 */
	struct ABP_Pottage_C_IsHeldByController_Params
	{
	public:
		class USceneComponent*                                     MotionController;                                        // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	/**
	 * Function BP_Pottage.BP_Pottage_C.TraceToPourPottage
	 */
	struct ABP_Pottage_C_TraceToPourPottage_Params
	{	};

	/**
	 * Function BP_Pottage.BP_Pottage_C.SetPottageProperties
	 */
	struct ABP_Pottage_C_SetPottageProperties_Params
	{
	public:
	...
	/**
	 * Function BP_Pottage.BP_Pottage_C.UserConstructionScript
	 */
	struct ABP_Pottage_C_UserConstructionScript_Params
	{	};

	/**
	 * Function BP_Pottage.BP_Pottage_C.ReceiveHit
	 */
	struct ABP_Pottage_C_ReceiveHit_Params
	{
	public:
		...
		unsigned char                                              UnknownData_7IIO[0x3];                                   // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BP_Pottage.BP_Pottage_C.Release
	 */
	struct ABP_Pottage_C_Release_Params
	{	};

	/**
	 * Function BP_Pottage.BP_Pottage_C.EnableHighlight
	 */
	struct ABP_Pottage_C_EnableHighlight_Params
	{	};

	/**
	 * Function BP_Pottage.BP_Pottage_C.DisableHighlight
	 */
	struct ABP_Pottage_C_DisableHighlight_Params
	{	};

	/**
	 * Function BP_Pottage.BP_Pottage_C.ReceiveBeginPlay
	 */
	struct ABP_Pottage_C_ReceiveBeginPlay_Params
	{	};

	/**
	 * Function BP_Pottage.BP_Pottage_C.BndEvt__ReturnVolume_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature
	 */
	struct ABP_Pottage_C_BndEvt__ReturnVolume_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature_Params
	{
	public:
		...
		unsigned char                                              UnknownData_T2TM[0x3];                                   // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		struct FHitResult                                          SweepResult;                                             // 0x0020(0x0088)  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	};

	/**
	 * Function BP_Pottage.BP_Pottage_C.ReturnEquipment
	 */
	struct ABP_Pottage_C_ReturnEquipment_Params
	{	};

	/**
	 * Function BP_Pottage.BP_Pottage_C.ForceRelease
	 */
	struct ABP_Pottage_C_ForceRelease_Params
	{	};

	/**
	 * Function BP_Pottage.BP_Pottage_C.ReceiveEndPlay
	 */
	struct ABP_Pottage_C_ReceiveEndPlay_Params
	{
	public:
	...
	/**
	 * Function BP_Pottage.BP_Pottage_C.ExecuteUbergraph_BP_Pottage
	 */
	struct ABP_Pottage_C_ExecuteUbergraph_BP_Pottage_Params
	{
	public:
