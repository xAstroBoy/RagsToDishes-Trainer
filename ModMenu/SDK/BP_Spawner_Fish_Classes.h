...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Spawner_Fish.BP_Spawner_Fish_C
	 * Size -> 0x0010 (FullSize[0x03F0] - InheritedSize[0x03E0])
	 */
	class ABP_Spawner_Fish_C : public ABP_Object_Spawner_C
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_BP_Spawner_Fish(int32_t EntryPoint);
