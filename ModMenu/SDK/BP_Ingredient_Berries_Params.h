...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_Ingredient_Berries.BP_Ingredient_Berries_C.Grab
	 */
	struct ABP_Ingredient_Berries_C_Grab_Params
	{
	public:
		...
		unsigned char                                              UnknownData_6MB6[0x7];                                   // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BP_Ingredient_Berries.BP_Ingredient_Berries_C.UserConstructionScript
	 */
	struct ABP_Ingredient_Berries_C_UserConstructionScript_Params
	{	};

	/**
	 * Function BP_Ingredient_Berries.BP_Ingredient_Berries_C.WashIngredient
	 */
	struct ABP_Ingredient_Berries_C_WashIngredient_Params
	{	};

	/**
	 * Function BP_Ingredient_Berries.BP_Ingredient_Berries_C.ExecuteUbergraph_BP_Ingredient_Berries
	 */
	struct ABP_Ingredient_Berries_C_ExecuteUbergraph_BP_Ingredient_Berries_Params
	{
	public:
