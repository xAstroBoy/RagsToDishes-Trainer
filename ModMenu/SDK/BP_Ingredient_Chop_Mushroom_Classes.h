...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Ingredient_Chop_Mushroom.BP_Ingredient_Chop_Mushroom_C
	 * Size -> 0x0008 (FullSize[0x0480] - InheritedSize[0x0478])
	 */
	class ABP_Ingredient_Chop_Mushroom_C : public ABP_Ingredient_C
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_BP_Ingredient_Chop_Mushroom(int32_t EntryPoint);
