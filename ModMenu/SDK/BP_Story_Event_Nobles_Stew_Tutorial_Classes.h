...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Story_Event_Nobles_Stew_Tutorial.BP_Story_Event_Nobles_Stew_Tutorial_C
	 * Size -> 0x0037 (FullSize[0x03F8] - InheritedSize[0x03C1])
	 */
	class ABP_Story_Event_Nobles_Stew_Tutorial_C : public ABP_Story_Event_C
	{
	public:
		unsigned char                                              UnknownData_4WAC[0x7];                                   // 0x03C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FPointerToUberGraphFrame                            UberGraphFrame;                                          // 0x03C8(0x0008) ZeroConstructor, Transient, DuplicateTransient
		class UStaticMeshComponent*                                DeliveyBay;                                              // 0x03D0(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
		...
		class UWidget_SE_Nobles_Stew_Tutorial_C*                   WidgetRef;                                               // 0x03E8(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void EventEnd();
		void ExecuteUbergraph_BP_Story_Event_Nobles_Stew_Tutorial(int32_t EntryPoint);
