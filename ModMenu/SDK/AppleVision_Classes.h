...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_T41I[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_UUR3[0x10];                                  // 0x0050(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_J3HX[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
