...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Story_Event_Royals_Sweets_Tutorial.BP_Story_Event_Royals_Sweets_Tutorial_C
	 * Size -> 0x00B7 (FullSize[0x0478] - InheritedSize[0x03C1])
	 */
	class ABP_Story_Event_Royals_Sweets_Tutorial_C : public ABP_Story_Event_C
	{
	public:
		unsigned char                                              UnknownData_AKMG[0x7];                                   // 0x03C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		float                                                      CustomerLeaveTL_Speed_E715E2AA48F28639549702BE09E6AD59;  // 0x0418(0x0004) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		ETimelineDirection                                         CustomerLeaveTL__Direction_E715E2AA48F28639549702BE09E6AD59; // 0x041C(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_HAXX[0x3];                                   // 0x041D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		float                                                      CustomerEnterTL_Speed_D302CE24427FBDD2BF780B8542D23250;  // 0x0428(0x0004) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		ETimelineDirection                                         CustomerEnterTL__Direction_D302CE24427FBDD2BF780B8542D23250; // 0x042C(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_HF2K[0x3];                                   // 0x042D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class UWidget_SE_Royals_Impatient_Customer_Order_C*        OrderWidgetRef;                                          // 0x0438(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		class UWidget_SE_Royals_Sweets_Tutorial_C*                 WidgetRef;                                               // 0x0440(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_NHRB[0x7];                                   // 0x0451(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_BP_Story_Event_Royals_Sweets_Tutorial(int32_t EntryPoint);
