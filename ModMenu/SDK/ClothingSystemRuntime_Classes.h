...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_OSR5[0x4];                                   // 0x0124(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_YEIY[0x4];                                   // 0x016C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_5QEZ[0x10];                                  // 0x0030(0x0010) MISSED OFFSET (PADDING)
