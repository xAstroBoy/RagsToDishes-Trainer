...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_XTDA[0x2];                                   // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		bool                                                       bChannelLinked : 1;                                      // 0x0024(0x0001) BIT_FIELD Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		...
		unsigned char                                              UnknownData_G0AE[0x3];                                   // 0x0025(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_B1W9[0x3];                                   // 0x000D(0x0003) MISSED OFFSET (PADDING)
	};
