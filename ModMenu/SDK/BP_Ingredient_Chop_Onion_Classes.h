...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Ingredient_Chop_Onion.BP_Ingredient_Chop_Onion_C
	 * Size -> 0x0008 (FullSize[0x0480] - InheritedSize[0x0478])
	 */
	class ABP_Ingredient_Chop_Onion_C : public ABP_Ingredient_C
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_BP_Ingredient_Chop_Onion(int32_t EntryPoint);
