...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00759C70
	 * 		Name   -> Function BP_Coin.BP_Coin_C.Grab
	 ...
	 */
	void ABP_Coin_C::Grab(class USceneComponent* MotionController, class UPhysicsHandleComponent* PhysicsHandle, class UPhysicsHandleComponent* AngularPhysicsHandle, EControllerHand hand, class ABP_MotionController_C* Controller, class USceneComponent* AttachPoint, class AActor** AttachedActor)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_Coin.BP_Coin_C.Grab");
		
		ABP_Coin_C_Grab_Params params {};
	 ...
	 * Function:
	 * 		RVA    -> 0x00759C70
	 * 		Name   -> Function BP_Coin.BP_Coin_C.IsHeldByController
	 * 		Flags  -> (Public, HasOutParms, BlueprintCallable, BlueprintEvent)
	 * Parameters:
	 * 		class USceneComponent*                             MotionController                                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 * 		bool                                               Return                                                     (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	void ABP_Coin_C::IsHeldByController(class USceneComponent* MotionController, bool* Return)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_Coin.BP_Coin_C.IsHeldByController");
		
		ABP_Coin_C_IsHeldByController_Params params {};
		params.MotionController = MotionController;
	 ...
	 * Function:
	 * 		RVA    -> 0x00759C70
	 * 		Name   -> Function BP_Coin.BP_Coin_C.DeleteSpawnedActor
	 * 		Flags  -> (Public, BlueprintCallable, BlueprintEvent)
	 */
	void ABP_Coin_C::DeleteSpawnedActor()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_Coin.BP_Coin_C.DeleteSpawnedActor");
		
		ABP_Coin_C_DeleteSpawnedActor_Params params {};
	 ...
	 * Function:
	 * 		RVA    -> 0x00759C70
	 * 		Name   -> Function BP_Coin.BP_Coin_C.EnableHighlight
	 * 		Flags  -> (Public, BlueprintCallable, BlueprintEvent)
	 */
	void ABP_Coin_C::EnableHighlight()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_Coin.BP_Coin_C.EnableHighlight");
		
		ABP_Coin_C_EnableHighlight_Params params {};
	 ...
	 * Function:
	 * 		RVA    -> 0x00759C70
	 * 		Name   -> Function BP_Coin.BP_Coin_C.DisableHighlight
	 * 		Flags  -> (Public, BlueprintCallable, BlueprintEvent)
	 */
	void ABP_Coin_C::DisableHighlight()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_Coin.BP_Coin_C.DisableHighlight");
		
		ABP_Coin_C_DisableHighlight_Params params {};
	 ...
	 * Function:
	 * 		RVA    -> 0x00759C70
	 * 		Name   -> Function BP_Coin.BP_Coin_C.Release
	 * 		Flags  -> (Public, BlueprintCallable, BlueprintEvent)
	 */
	void ABP_Coin_C::Release()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_Coin.BP_Coin_C.Release");
		
		ABP_Coin_C_Release_Params params {};
