...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Ingredient_Fish_Nobles.BP_Ingredient_Fish_Nobles_C
	 * Size -> 0x0011 (FullSize[0x0489] - InheritedSize[0x0478])
	 */
	class ABP_Ingredient_Fish_Nobles_C : public ABP_Ingredient_C
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_BP_Ingredient_Fish_Nobles(int32_t EntryPoint);
