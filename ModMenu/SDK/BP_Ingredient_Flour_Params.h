...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_Ingredient_Flour.BP_Ingredient_Flour_C.Grab
	 */
	struct ABP_Ingredient_Flour_C_Grab_Params
	{
	public:
		...
		unsigned char                                              UnknownData_6KUU[0x7];                                   // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BP_Ingredient_Flour.BP_Ingredient_Flour_C.UserConstructionScript
	 */
	struct ABP_Ingredient_Flour_C_UserConstructionScript_Params
	{	};

	/**
	 * Function BP_Ingredient_Flour.BP_Ingredient_Flour_C.Release
	 */
	struct ABP_Ingredient_Flour_C_Release_Params
	{	};

	/**
	 * Function BP_Ingredient_Flour.BP_Ingredient_Flour_C.ExecuteUbergraph_BP_Ingredient_Flour
	 */
	struct ABP_Ingredient_Flour_C_ExecuteUbergraph_BP_Ingredient_Flour_Params
	{
	public:
