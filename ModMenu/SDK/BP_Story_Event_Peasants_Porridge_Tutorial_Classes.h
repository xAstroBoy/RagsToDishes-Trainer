...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Story_Event_Peasants_Porridge_Tutorial.BP_Story_Event_Peasants_Porridge_Tutorial_C
	 * Size -> 0x0037 (FullSize[0x03F8] - InheritedSize[0x03C1])
	 */
	class ABP_Story_Event_Peasants_Porridge_Tutorial_C : public ABP_Story_Event_C
	{
	public:
		unsigned char                                              UnknownData_BQCB[0x7];                                   // 0x03C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class UWidget_SE_Peasant_Porridge_Tutorial_C*              WidgetRef;                                               // 0x03E8(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void EventEnd();
		void ExecuteUbergraph_BP_Story_Event_Peasants_Porridge_Tutorial(int32_t EntryPoint);
