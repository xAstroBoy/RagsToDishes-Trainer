...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_Ingredient_Fish_Nobles.BP_Ingredient_Fish_Nobles_C.Grab
	 */
	struct ABP_Ingredient_Fish_Nobles_C_Grab_Params
	{
	public:
		...
		unsigned char                                              UnknownData_JBVL[0x7];                                   // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BP_Ingredient_Fish_Nobles.BP_Ingredient_Fish_Nobles_C.UserConstructionScript
	 */
	struct ABP_Ingredient_Fish_Nobles_C_UserConstructionScript_Params
	{	};

	/**
	 * Function BP_Ingredient_Fish_Nobles.BP_Ingredient_Fish_Nobles_C.ChopIngredient
	 */
	struct ABP_Ingredient_Fish_Nobles_C_ChopIngredient_Params
	{
	public:
	...
	/**
	 * Function BP_Ingredient_Fish_Nobles.BP_Ingredient_Fish_Nobles_C.ExecuteUbergraph_BP_Ingredient_Fish_Nobles
	 */
	struct ABP_Ingredient_Fish_Nobles_C_ExecuteUbergraph_BP_Ingredient_Fish_Nobles_Params
	{
	public:
