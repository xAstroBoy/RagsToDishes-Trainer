...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass Widget_SE_Nobles_Pie_Tutorial.Widget_SE_Nobles_Pie_Tutorial_C
	 * Size -> 0x0058 (FullSize[0x02E8] - InheritedSize[0x0290])
	 */
	class UWidget_SE_Nobles_Pie_Tutorial_C : public UWidget_UI_C
	{
	public:
		...
		class UVerticalBox*                                        PieTutorial;                                             // 0x02C8(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_M6NW[0x4];                                   // 0x02DC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class ABP_Story_Event_Nobles_Pie_Tutorial_C*               StoryEventRef;                                           // 0x02E0(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void SkipTextRender();
		void ExecuteUbergraph_Widget_SE_Nobles_Pie_Tutorial(int32_t EntryPoint);
