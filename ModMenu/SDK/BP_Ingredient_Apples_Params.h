...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_Ingredient_Apples.BP_Ingredient_Apples_C.Grab
	 */
	struct ABP_Ingredient_Apples_C_Grab_Params
	{
	public:
		...
		unsigned char                                              UnknownData_5SKM[0x7];                                   // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BP_Ingredient_Apples.BP_Ingredient_Apples_C.UserConstructionScript
	 */
	struct ABP_Ingredient_Apples_C_UserConstructionScript_Params
	{	};

	/**
	 * Function BP_Ingredient_Apples.BP_Ingredient_Apples_C.WashIngredient
	 */
	struct ABP_Ingredient_Apples_C_WashIngredient_Params
	{	};

	/**
	 * Function BP_Ingredient_Apples.BP_Ingredient_Apples_C.ExecuteUbergraph_BP_Ingredient_Apples
	 */
	struct ABP_Ingredient_Apples_C_ExecuteUbergraph_BP_Ingredient_Apples_Params
	{
	public:
