...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_Achievement.BP_Achievement_C.Grab
	 */
	struct ABP_Achievement_C_Grab_Params
	{
	public:
		...
		unsigned char                                              UnknownData_ZUKS[0x7];                                   // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BP_Achievement.BP_Achievement_C.IsHeldByController
	 */
	struct ABP_Achievement_C_IsHeldByController_Params
	{
	public:
		class USceneComponent*                                     MotionController;                                        // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	/**
	 * Function BP_Achievement.BP_Achievement_C.UserConstructionScript
	 */
	struct ABP_Achievement_C_UserConstructionScript_Params
	{	};

	/**
	 * Function BP_Achievement.BP_Achievement_C.EnableHighlight
	 */
	struct ABP_Achievement_C_EnableHighlight_Params
	{	};

	/**
	 * Function BP_Achievement.BP_Achievement_C.DisableHighlight
	 */
	struct ABP_Achievement_C_DisableHighlight_Params
	{	};

	/**
	 * Function BP_Achievement.BP_Achievement_C.Release
	 */
	struct ABP_Achievement_C_Release_Params
	{	};

	/**
	 * Function BP_Achievement.BP_Achievement_C.AwardActive
	 */
	struct ABP_Achievement_C_AwardActive_Params
	{	};

	/**
	 * Function BP_Achievement.BP_Achievement_C.ReceiveBeginPlay
	 */
	struct ABP_Achievement_C_ReceiveBeginPlay_Params
	{	};

	/**
	 * Function BP_Achievement.BP_Achievement_C.ExecuteUbergraph_BP_Achievement
	 */
	struct ABP_Achievement_C_ExecuteUbergraph_BP_Achievement_Params
	{
	public:
