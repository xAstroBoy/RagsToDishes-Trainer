...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Ingredient_Apples.BP_Ingredient_Apples_C
	 * Size -> 0x0010 (FullSize[0x0488] - InheritedSize[0x0478])
	 */
	class ABP_Ingredient_Apples_C : public ABP_Ingredient_C
	{
	public:
	...
	public:
		...
		void WashIngredient();
		void ExecuteUbergraph_BP_Ingredient_Apples(int32_t EntryPoint);
