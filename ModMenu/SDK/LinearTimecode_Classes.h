...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_IA2O[0x4];                                   // 0x025C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_XN3Y[0x30];                                  // 0x0270(0x0030) MISSED OFFSET (PADDING)
