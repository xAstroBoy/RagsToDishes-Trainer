...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_D37B[0x28];                                  // 0x0028(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_VTUH[0x6];                                   // 0x0052(0x0006) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_KP3M[0x28];                                  // 0x0068(0x0028) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_T8M4[0x3];                                   // 0x0069(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_E27I[0x7];                                   // 0x0071(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_M8RK[0x7];                                   // 0x0091(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_JW1Y[0x20];                                  // 0x00A0(0x0020) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_7QLP[0x10];                                  // 0x0058(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_BSL8[0x70];                                  // 0x0068(0x0070) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_IVXA[0x4];                                   // 0x00DC(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_UJMG[0xE];                                   // 0x00DA(0x000E) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_60F5[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_BJAD[0x6];                                   // 0x00CA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_EX17[0x100];                                 // 0x00F0(0x0100) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_SMDZ[0xB];                                   // 0x01F1(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_0D75[0x4];                                   // 0x020C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_1N77[0x80];                                  // 0x0060(0x0080) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_0WLK[0x2];                                   // 0x00E2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_QCVQ[0x3];                                   // 0x0069(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_WQ3J[0x10];                                  // 0x0080(0x0010) MISSED OFFSET (PADDING)
