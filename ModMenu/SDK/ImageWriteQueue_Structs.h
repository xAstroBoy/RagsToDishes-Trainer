...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_RC8Z[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_CZZS[0x42];                                  // 0x001E(0x0042) MISSED OFFSET (PADDING)
	};
