...
namespace CG
{
	 ...
	 * Size -> 0x05F8 (FullSize[0x0620] - InheritedSize[0x0028])
	 */
	class UEditableMesh : public UObject
	{
	public:
		unsigned char                                              UnknownData_2S73[0x300];                                 // 0x0028(0x0300) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<class UEditableMeshAdapter*>                        Adapters;                                                // 0x0328(0x0010) ZeroConstructor, NativeAccessSpecifierPublic
		int32_t                                                    TextureCoordinateCount;                                  // 0x0338(0x0004) BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_12Q4[0xF8];                                  // 0x033C(0x00F8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		int32_t                                                    PendingCompactCounter;                                   // 0x0434(0x0004) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		int32_t                                                    SubdivisionCount;                                        // 0x0438(0x0004) BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_AA19[0x1E4];                                 // 0x043C(0x01E4) MISSED OFFSET (PADDING)
	...
	public:
		...
		void GetPolygonHoleVertices(const struct FPolygonID& PolygonID, int32_t HoleNumber, TArray<struct FVertexID>* OutHoleVertexIDs);
		void GetPolygonHoleVertexInstances(const struct FPolygonID& PolygonID, int32_t HoleNumber, TArray<struct FVertexInstanceID>* OutHoleVertexInstanceIDs);
		struct FVertexInstanceID GetPolygonHoleVertexInstance(const struct FPolygonID& PolygonID, int32_t HoleNumber, int32_t PolygonVertexNumber);
		int32_t GetPolygonHoleVertexCount(const struct FPolygonID& PolygonID, int32_t HoleNumber);
		struct FVertexID GetPolygonHoleVertex(const struct FPolygonID& PolygonID, int32_t HoleNumber, int32_t PolygonVertexNumber);
		void GetPolygonHoleEdges(const struct FPolygonID& PolygonID, int32_t HoleNumber, TArray<struct FEdgeID>* OutHoleEdgeIDs);
		int32_t GetPolygonHoleEdgeCount(const struct FPolygonID& PolygonID, int32_t HoleNumber);
		struct FEdgeID GetPolygonHoleEdge(const struct FPolygonID& PolygonID, int32_t HoleNumber, int32_t HoleEdgeNumber);
		int32_t GetPolygonHoleCount(const struct FPolygonID& PolygonID);
		...
		int32_t FindPolygonHoleVertexNumberForVertex(const struct FPolygonID& PolygonID, int32_t HoleNumber, const struct FVertexID& VertexID);
		int32_t FindPolygonHoleEdgeNumberForVertices(const struct FPolygonID& PolygonID, int32_t HoleNumber, const struct FVertexID& EdgeVertexID0, const struct FVertexID& EdgeVertexID1);
		...
		void CreateMissingPolygonHoleEdges(const struct FPolygonID& PolygonID, int32_t HoleNumber, TArray<struct FEdgeID>* OutNewEdgeIDs);
	...
	public:
		...
		unsigned char                                              UnknownData_7QFZ[0xA4];                                  // 0x003C(0x00A4) MISSED OFFSET (PADDING)
